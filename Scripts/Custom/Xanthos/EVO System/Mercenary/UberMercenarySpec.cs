...
namespace Xanthos.Evo
{
	public sealed class UberMercenarySpec : BaseEvoSpec
	{
		...
		UberMercenarySpec()
		{
			...
			m_Skills = new SkillName[11] { SkillName.Magery, SkillName.Mysticism, SkillName.Necromancy, SkillName.Healing,
										  SkillName.Tactics, SkillName.Meditation, SkillName.Anatomy, SkillName.Parry,
										  SkillName.MagicResist, SkillName.Healing, SkillName.Macing };
